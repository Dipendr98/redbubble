...
import { optimizePrompt } from './orchestrator/StickerMaster.js';
...
/* ─── API: Optimize & Review Prompt (Modular Orchestrator) ─── */
app.post('/api/optimize-prompt', async (req, res) => {
  ...
  try {
    const optimized = await optimizePrompt(prompt, token);
    res.json({ optimized });
  } catch (error) {
